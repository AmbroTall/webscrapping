...
Northern_Irish_Premiership = ['Linfield FC', 'Larne FC', 'Cliftonville FC', 'Crusaders FC', 'Glentoran', 'Coleraine FC', 'Glenavon', 'Loughgall FC', 'Carrick Rangers','Dungannon Swifts','Ballymena United', 'Newry City']

France_Ligue1 = ['Olympique Marseille', 'Lille OSC', 'OGC Nice', 'Lorient', 'PSG', 'Stade Brest 29', 'Clermont Foot 63', 'Le Havre AC', 'RC Lens', 'Olympique Lyon', 'FC Metz',
                 'Monaco', 'Montpellier HSC', 'FC Nantes', 'Stade Rennes', 'Strasbourg Alsace', 'Toulouse FC', 'Stade Reims']

France_Ligue2 = ['SM Caen', 'Grenoble Foot', 'Amiens SC', 'SC Bastia', 'ESTAC Troyes', 'Rodez Aveyron Football', 'USL Dunkerque', 'Ajaccio', 'AJ Auxerre',
                 'Guingamp', 'Pau FC', 'Lavallois MFC', 'US Concarneau', 'Angers SCO', 'FC Annecy', 'AS Saint-Etienne', 'Quevilly-Rouen Metropole', 'Paris FC',
                 'Valenciennes FC', 'Girondins Bordeaux']

Laliga = ['Rayo Vallecano', 'Valencia CF', 'Deportivo Alaves', 'Athletic Bilbao', 'Atletico Madrid', 'FC Barcelona', 'Cadiz', 'RC Celta de Vigo',
                          'Getafe CF', 'Girona FC', 'Granada', 'UD Las Palmas', 'RCD Mallorca', 'CA Osasuna', 'Real Betis Seville', 'Real Madrid', 'Villarreal',
                          'Real Sociedad San Sebastian', 'Sevilla FC', 'UD Almeria']
...
Spain_Secunda_Division = ['Real Valladolid', 'SD Amorebieta', 'Levante UD', 'Albacete Balompie', 'AD Alcorcon', 'Burgos CF', 'FC Cartagena', 'SD Eibar', 'Elche CF',
                          'Eldense', 'Espanyol Barcelona', 'FC Andorra', 'SD Huesca', 'CD Leganes', 'Mirandes', 'Racing Club de Ferrol', 'Racing Santander',
