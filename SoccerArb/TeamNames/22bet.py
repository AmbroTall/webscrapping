...
England_League_Two = ['Sutton United', 'Accrington Stanley', 'Milton Keynes Dons', 'Salford City', 'Morecambe', 'Barrow ', 'Crawley Town',
                      'Gillingham', 'Harrogate (Harrogate Town)', 'Crewe Alexandra', 'Mansfield (Mansfield Town)', 'Grimsby Town', 'Wimbledon', 'Swindon (Swindon Town)', 'Colchester (Colchester United)',
                      'Tranmere Rovers', 'Bradford City', 'Doncaster Rovers', 'Stockport County', 'Wrexham', 'Forest Green Rovers', 'Newport County', 'Notts County',
                      'Walsall ']
...
# ----------Ice Hockey------------
# Finland Elite League
finland_elite_league = ['Tappara', 'Ilves', 'HIFK', 'Oulun Karpat', 'JYP Jyvaskyla', 'Lukko','Assat', 'Mikkelin Jukurit', 'KalPa', 'KooKoo Kouvola', 'Vaasan Sport', 'Pelicans', 'TPS', 'Hameenlinna', 'SaiPa']
# finland_elite_league = ['Tappara', 'Ilves', 'IFK Helsinki', 'Oulun Karpat', 'JYP', 'Lukko','Assat', 'Jukurit', 'KalPa', 'KooKoo Kouvola', 'Vaasan Sport', 'Pelicans', 'TPS Turku', 'Hameenlinna', 'SaiPa']
