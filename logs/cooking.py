...
def update_task(project, task, task_created_date, task_type, start_time, end_time, subproject):
    url = "https://100098.pythonanywhere.com/task_module/?type=update_candidate_task&task_id=651950f910713e24e8475a92"
    payload = json.dumps({
        "project": project,
        "applicant": "Winder",
        "task": task,
...
task_titles = ["Clear bugs in stapel scale at document level", "Clear bugs in nps scale at document level", "Testing paired and comparison scale", "Creating a document map to test different scales at the document level"]
